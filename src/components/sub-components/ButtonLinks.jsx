	...
	return (
		<div className='flex justify-start space-x-2'>
			<Link href='https://github.com/zcharz' target="_blank">
				<FaGithub size={30} className='text-slate-800 hover:text-slate-100 duration-200'/>
			</Link>

			<Link href='https://www.linkedin.com/in/zhao-charlie/' target="_blank">
				<FaLinkedin size={30} className='text-slate-800 hover:text-slate-100 duration-200'/>
			</Link>
