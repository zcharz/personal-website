    ...
    return (
        <div className='fixed z-50 pl-8 pt-8 flex flex-row font-bold space-x-4'>
            ...
            <div className='flex flex-col text-xl space-y-2 text-slate-100 drop-shadow-lg'>
                ...
                <button onClick={() => scrollTo('experience')} className='text-left hover:text-emerald-400 duration-200'>experience</button>
                <button onClick={() => scrollTo('projects')} className='text-left hover:text-emerald-400 duration-200'>projects</button>
                <button onClick={() => scrollTo('music')} className='text-left hover:text-emerald-400 duration-200'>music</button>
                <button onClick={() => scrollTo('contact')} className='text-left hover:text-emerald-400 duration-200'>contact</button>
                {/* {sections.map((item) => (
